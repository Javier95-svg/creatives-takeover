const StoriesWallpaper = () => {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
      ...
      {/* RGB-themed gradient orbs - consistent with other wallpapers */}
      {/* Blue orb - top left */}
      ...
      <svg className="absolute inset-0 w-full h-full dark:opacity-15 opacity-8" viewBox="0 0 1440 900">
        <defs>
          <linearGradient id="stories-connector-blue" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="rgba(59,130,246,0)" />
            <stop offset="50%" stopColor="rgba(59,130,246,0.3)" />
            <stop offset="100%" stopColor="rgba(59,130,246,0)" />
          </linearGradient>
          <linearGradient id="stories-connector-red" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="rgba(239,68,68,0)" />
            <stop offset="50%" stopColor="rgba(239,68,68,0.25)" />
            <stop offset="100%" stopColor="rgba(239,68,68,0)" />
          </linearGradient>
          <linearGradient id="stories-connector-green" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <path 
          ...
          fill="none" 
          stroke="url(#stories-connector-blue)" 
          strokeWidth="1.2" 
        ...
        <path 
          ...
          fill="none" 
          stroke="url(#stories-connector-red)" 
          strokeWidth="1.1" 
        ...
        <path 
          ...
          fill="none" 
          stroke="url(#stories-connector-green)" 
          strokeWidth="1.2" 
      ...
      <div className="absolute inset-0 
        dark:from-background/72 dark:via-background/42 dark:to-background/78 
        from-background/90 via-background/95 to-background/90 
        bg-gradient-to-b" />
    </div>
  );
};
