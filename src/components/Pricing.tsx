...
const PLAN_CONFIG: Array<{
...
}> = [
  {
    ...
    features: [
      ...
      "1 free discovery call per month",
      "1 co-founder post per month",
      "VC Search and Accelerator Hunt: browse only",
      "Prompt Library: Business Case template only",
    ],
  },
  {
    key: "starter",
    ...
    features: [
      ...
      "MVP Builder, Tech Stack, GTM Strategist, and Directories stay in preview mode",
      "2 free discovery calls per month",
      "2 co-founder posts per month",
      "2 VC profiles and 2 accelerator profiles per cycle",
  ...
  },
  {
    ...
    features: [
      ...
      "Waitlist, PMF, Tech Stack, and Directories included",
      "MVP Builder and GTM Strategist always consume credits",
      "3 free discovery calls per month, then 10 credits each",
      "Unlimited co-founder posts",
      "10 VC profiles and 10 accelerator profiles per cycle",
    ],
  },
  {
    key: "pro",
    ...
    features: [
      ...
      "Monthly group office hours and priority support",
    ],
  },
];
