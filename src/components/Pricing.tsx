  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-section-mobile md:pt-32 lg:pt-36 lg:pb-section-desktop" id="pricing-plans">
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-7 xl:gap-10 max-w-[100rem] mx-auto items-start">
          {PLAN_CONFIG.map((plan, index) => {
            ...
            return (
              <div
                key={plan.key}
                className={`relative rounded-2xl border bg-card/80 p-6 sm:p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl flex flex-col backdrop-blur xl:min-w-[296px] ${cardStyle.border} ${
