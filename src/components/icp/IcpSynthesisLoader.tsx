...
export function IcpSynthesisLoader({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white px-6 text-slate-950">
      <div className="w-full max-w-xl space-y-8">
        ...
        <div className="space-y-4 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_28px_80px_-48px_rgba(15,23,42,0.35)]">
          ...
          {showSlowHint ? (
            <p className="pt-2 text-sm text-slate-500">Almost there — we're being thorough.</p>
          ) : null}
