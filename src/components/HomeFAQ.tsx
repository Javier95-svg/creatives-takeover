...
const HomeFAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Rookie is free forever with 25 credits per month. It is built for idea clarity and first traction: ICP Builder is free, Insighta Test and Newspaper are included, community browsing stays open, and you get 1 free discovery call plus 1 co-founder post per billing cycle.\n\nStarter is $9/month or $79/year with 50 credits per month. It unlocks credit-based Waitlist Maker and PMF Lab, gives you 2 discovery calls, 2 co-founder posts, 2 VC profiles, 2 accelerator profiles, basic email templates, and 5 prompt templates.\n\nRising is $29/month or $239/year with 100 credits per month. It unlocks the full toolset, full email templates, pitch deck analyzer, and 10 VC plus 10 accelerator profiles per cycle. Most tools are included without per-use charges, but MVP Builder and GTM Strategist still consume credits.\n\nPro is $65/month or $589/year with 300 credits per month. It adds unlimited discovery calls, unlimited VC and accelerator profile views, Angels community access, group office hours, and priority support. Extra credit packs remain available on any plan."
    }
  ];
