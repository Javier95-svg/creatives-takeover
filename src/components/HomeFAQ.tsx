...
const HomeFAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Rookie is free forever with 50 credits per month. It is built for idea clarity and first traction: ICP Builder is free, Demo Studio uses 4 credits on Rookie, Insighta Test and Newspaper are included, community browsing stays open, and you get unlimited Discovery Calls at 10 credits per confirmed booking. Co-founder posting is open to every plan and costs 5 credits per published post.\n\nStarter is $9/month or $79/year with 100 credits per month. It unlocks PMF Lab as a credit-metered analysis tool, 2 VC profiles, 2 accelerator profiles, full Email Templates access, and Prompt Library access for free models only. Demo Studio costs 3 credits on Starter and above.\n\nRising is $29/month or $239/year with 250 credits per month. It unlocks the build and go-to-market toolset: MVP Builder, Tech Stack Builder, GTM Strategist, Directories, full Prompt Library, and Pitch Deck Analyzer. MVP Builder uses per-action credits for builds, edits, bug fixes, deploys, and restores.\n\nPro is $65/month or $589/year with 600 credits per month. It adds Find Your Angel, unlimited VC and accelerator profile views, group office hours, and priority support. Extra credit packs remain available on any plan."
    }
  ];
