        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
            <div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed font-poppins">We're entering a world where AI and automation will eliminate most traditional jobs but also unlock unprecedented entrepreneurial opportunities. Everyone will need to think and act like a founder, and we're here to make that transition possible.</p>
            </div>
