          ...
          <div className="relative animate-slide-in-right" style={{
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border">
                <img src={solopreneurHero} alt="Smiling white woman solopreneur at a creative beach workspace, face clearly visible under a colorful parasol" className="w-full h-auto object-cover" loading="lazy" />
