  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute left-[9%] top-28 hidden w-72 rotate-[-7deg] rounded-[2rem] border border-amber-500/20 bg-background/75 p-5 shadow-[0_28px_90px_rgba(217,119,6,0.14)] backdrop-blur xl:block">
        <p className="text-[11px] uppercase tracking-[0.34em] text-amber-700/75">Cohort Board</p>
        <div className="mt-4 space-y-3">
          <div className="rounded-2xl border border-amber-500/20 bg-amber-500/10 px-3 py-2 text-[11px] font-medium text-amber-700">
            Batch Review
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-2xl border border-orange-500/20 bg-orange-500/10 px-3 py-2 text-center text-[11px] font-medium text-orange-700">Mentors</div>
            <div className="rounded-2xl border border-sky-500/20 bg-sky-500/10 px-3 py-2 text-center text-[11px] font-medium text-sky-700">Funding</div>
          </div>
      ...
      <div className="absolute right-[8%] top-36 hidden w-80 rotate-[8deg] rounded-[2rem] border border-orange-500/20 bg-background/80 p-5 shadow-[0_34px_100px_rgba(249,115,22,0.14)] backdrop-blur xl:block">
        <div className="flex items-center justify-between">
          <p className="text-[11px] uppercase tracking-[0.32em] text-orange-700/75">Launch Map</p>
        ...
        <div className="relative mt-6 h-28">
          ...
          <div className="absolute left-12 top-16 text-[10px] uppercase tracking-[0.22em] text-muted-foreground">Apply</div>
          <div className="absolute left-30 top-0 text-[10px] uppercase tracking-[0.22em] text-muted-foreground">Mentor</div>
          <div className="absolute left-48 top-20 text-[10px] uppercase tracking-[0.22em] text-muted-foreground">Build</div>
          <div className="absolute right-2 top-0 text-[10px] uppercase tracking-[0.22em] text-muted-foreground">Demo</div>
        </div>
      </div>
