        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center flex flex-col justify-center">
            ...
            <p className="font-poppins text-base sm:text-lg text-muted-foreground mb-8 max-w-xl mx-auto leading-relaxed">
              We blend technology, strategy and community to automatize startup formation, empowering founders with business development guidance, expert support, and fundraising tools.
            </p>
