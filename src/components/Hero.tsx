      ...
      <div className="container mx-auto relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-slide-up takeover-title creatives-font leading-tight">
            <span className="animated-gradient">Turn Your Creative Skill Into a $5K/Month Business in 30 Days</span>
          </h1>
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-4 max-w-2xl mx-auto leading-relaxed animate-slide-up px-4" style={{ animationDelay: '0.2s' }}>
            The AI co-founder that gets creatives from scattered ideas to first dollar in 30 days.
          </p>
          
          <p className="text-sm sm:text-base text-muted-foreground/80 mb-4 max-w-2xl mx-auto animate-slide-up px-4" style={{ animationDelay: '0.25s' }}>
            Whether you're a designer, photographer, writer, artist, or content creator—we'll help you package your skills, validate your market, and launch fast.
          </p>
