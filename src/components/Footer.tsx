            ...
            <ul className="mt-3 flex flex-wrap items-center gap-4">
              ...
              <li className="flex items-center">
                <a
                  ...
                  className="flex items-center justify-center"
                >
                  <svg className="h-4 w-4 text-foreground hover:text-muted-foreground transition-colors" viewBox="0 0 192 192" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
