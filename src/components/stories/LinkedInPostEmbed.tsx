...
export const LinkedInPostEmbed = ({ url, title, excerpt, hashtags }: LinkedInPostEmbedProps) => {
  ...
  return (
    <div className="w-full border rounded-lg overflow-hidden bg-white dark:bg-gray-900 shadow-sm">
