    ...
    <section className="py-20 lg:py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 animate-fade-in px-4">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 sm:mb-12 pb-2 bg-gradient-to-r from-blue-400 via-blue-500 to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(59,130,246,0.5)]">
            Here's What You Get
          </h2>
