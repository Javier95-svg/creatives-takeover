                ...
                >
                  ...
                  <div className="flex gap-1">
                    <Button
                      ...
                      disabled={loading}
                      className="h-8 w-8 p-0 bg-green-500/10 border-green-500/20 hover:bg-green-500/20"
                    >
                    ...
                    <Button
                      ...
                      disabled={loading}
                      className="h-8 w-8 p-0 bg-red-500/10 border-red-500/20 hover:bg-red-500/20"
                    >
