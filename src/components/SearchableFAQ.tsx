...
const SearchableFAQ = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Yes. Rookie is completely free forever with no credit card required. You get 50 credits per month, free ICP Builder access, Insighta Test — Fundraising Readiness, Newspaper, mentor and co-founder browsing, mentor messaging and saving, preview access to later-stage tools, and free co-founder posting.",
      popular: true,
