...
export const listAdminDiscoveryCalls = () =>
  invoke<{ success: boolean; calls: Array<Record<string, unknown>>; health: Array<Record<string, unknown>>; notifications: Array<Record<string, unknown>>; notificationAlerts: Array<Record<string, unknown>>; events: Array<Record<string, unknown>>; rounds: Array<Record<string, unknown>>; reservations: Array<Record<string, unknown>>; calendarJobs: Array<Record<string, unknown>>; attendance: Array<Record<string, unknown>>; attendanceJobs: Array<Record<string, unknown>>; outcomes: Array<Record<string, unknown>> }>('discovery-call-service', { action: 'listAdminCalls' });
