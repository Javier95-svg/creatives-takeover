...
export const ACTIVATION_CATALOG: Record<ActivationIntent, ActivationCatalogEntry> = {
  first_customer_sprint: { intent: 'first_customer_sprint', toolKey: 'first_customer_sprint', label: 'Run your first demand cycle', description: 'Apply to execute one buyer-facing acquisition cycle with 10 qualified prospects and a decision.', output: 'A buyer-backed acquisition decision', route: '/first-customer-sprint/apply?source=onboarding', estimatedMinutes: 5, artifactType: 'acquisition_cycle', steps: ['Confirm pilot fit', 'Pre-register one acquisition cycle', 'Send 10 messages and review the buyer evidence'] },
