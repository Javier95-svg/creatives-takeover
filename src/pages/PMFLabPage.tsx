...
export default function PMFLabPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'PMF Lab is designed as the third and final validation tool in the BizMap journey — it builds directly on the work you did in Stage I and Stage II. In ICP Builder, you defined who your target customer is: their segment, recurring pain, and behavioral triggers. In Waitlist Maker, you tested whether that customer would express enough interest to sign up before your product exists. PMF Lab now asks whether the real-world evidence you have gathered confirms or contradicts those earlier assumptions.\n\nWhen you open PMF Lab, it automatically pulls your ICP persona name and your waitlist product name and displays them in a context banner. This is intentional — the questions in the evidence form are designed to be answered in relation to the ICP you defined and the waitlist you built, not in isolation. If your interview segments do not match your ICP target, or if buying intent from your waitlist leads is lower than expected, the report will surface that disconnect explicitly.\n\nThe output of PMF Lab — your PMF Readiness Score and the segment-level breakdown — is what you carry into Stage IV (Building). It becomes the evidence base for scoping your MVP, prioritising features, and making the case to co-founders, advisors, or investors that you are building for a real, validated demand. Think of the three tools as one continuous workflow: define your customer, prove they want something, then verify the evidence is strong enough to build.',
    },
  ];
