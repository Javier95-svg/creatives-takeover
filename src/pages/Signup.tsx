          ...
          <CardContent>
            <form onSubmit={handleSubmit} autoComplete="on" className="space-y-5">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="relative p-[2px] rounded-md bg-gradient-to-r from-[#4285F4] via-[#EA4335] via-[#FBBC05] to-[#34A853]">
                  <Button
                    type="button"
                    variant="outline"
                    disabled={isLoading}
                  ...
                  >
                    ...
                    <span 
                      className="bg-clip-text text-transparent bg-gradient-to-r from-[#4285F4] via-[#EA4335] via-[#FBBC05] to-[#34A853] font-medium"
                    >
