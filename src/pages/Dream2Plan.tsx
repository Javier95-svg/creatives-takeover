              ...
              <TabsContent value="bizmap">
                ...
                <div className="flex flex-row gap-4 lg:gap-6 mb-6 sm:mb-8">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="glass-card border border-primary/30 shadow-2xl backdrop-blur-xl h-[700px] hover-lift transition-all duration-500 hover:shadow-primary/20 rounded-xl lg:rounded-2xl overflow-hidden">
                      <BizMapChat
