...
export default function BizMapJourneyHubPage() {
  ...
  if (founderCycle.rolloutEnabled && founderCycle.isLoading) {
    return (
      <div className="min-h-screen bg-background">
        <Navigation />
        <main className="nav-offset px-4 pt-32">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="nav-offset px-4 pt-28 pb-20 md:pt-32 lg:pt-36">
        <div className="container mx-auto max-w-6xl space-y-8">
          ...
          <RelatedToolsSection
            tools={[
              ...
              { name: "PMF Lab", description: "Score product-market fit signals across five evidence dimensions.", url: "/pmf-lab" },
