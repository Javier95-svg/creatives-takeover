...
export const chatbotFAQ: FAQItem[] = [
  ...
  createFAQItem({
    ...
    answer: 'We offer four plans: Rookie starts free with 50 credits and standard AI models. Starter is $9/month with 100 credits, the PROVE workspace, Email Templates, and deeper research. Rising is $29/month with 250 credits, advanced MVP models, and the complete First Customer Proof workflow. Pro is $65/month with 600 credits, Find Your Angel, and unlimited research. Core founder tools are available across plans and use credits where noted.',
  ...
  createFAQItem({
    ...
    answer: 'Yes. Rookie is free forever and gives you 50 monthly credits, core founder tools with standard AI models, Insighta Test, Newspaper, investor and accelerator browsing, and 3 directory visits. Mentor marketplace access is included on every plan, with mentor services paid separately.',
  ...
  createFAQItem({
    ...
    answer: 'We offer live chat, email support, a comprehensive FAQ, and product guidance. Mentor marketplace access and Discovery Call requests are available on every plan; mentor services are priced and paid separately.',
