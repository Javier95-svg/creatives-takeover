...
export const chatbotFAQ: FAQItem[] = [
  ...
  createFAQItem({
    ...
    answer: 'We offer four plans: Rookie is free with 25 credits/month, Starter is $9/month or $79/year with 50 credits, Rising is $29/month or $239/year with 100 credits, and Pro is $65/month or $589/year with 300 credits. MVP Builder and GTM Strategist still consume credits on every plan.',
  ...
  createFAQItem({
    ...
    answer: 'Yes. Rookie is free forever and gives you 25 monthly credits, free ICP Builder access, Insighta Test, Newspaper, and early-stage browsing or preview access across the platform. You can also schedule a live demo to see the full workflow before upgrading.',
