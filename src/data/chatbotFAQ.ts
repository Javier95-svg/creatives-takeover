...
export const chatbotFAQ: FAQItem[] = [
  ...
  createFAQItem({
    ...
    answer: 'Yes. Rookie is free forever and gives you 50 monthly credits, free ICP Builder access, Insighta Test, Newspaper, and early-stage browsing or preview access across the platform. You can also schedule a live demo to see the full workflow before upgrading.',
