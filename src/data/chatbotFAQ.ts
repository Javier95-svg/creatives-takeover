...
export const chatbotFAQ: FAQItem[] = [
  ...
  createFAQItem({
    ...
    answer: 'We offer four plans: Rookie is free with 10 credits/month, Starter is $9/month or $79/year with 30 credits, Rising is $29/month or $239/year with 75 credits, and Pro is $65/month or $589/year with 150 credits. Waitlist Maker costs 4 credits on Rookie and 3 credits on paid plans. MVP Builder is available on every plan and charges per AI action.',
    shortAnswer: 'Rookie, Starter, Rising, and Pro give you 10, 30, 75, and 150 monthly credits respectively.',
