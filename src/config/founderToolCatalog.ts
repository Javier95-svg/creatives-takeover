...
export const FOUNDER_TOOL_CATALOG = [
  ...
  },
  {
    ...
    stageNumber: 5,
    role: 'support',
    name: 'First Customer Proof',
    route: '/go-to-market?workspace=first-customer-proof',
    purpose: 'Execute one measurable acquisition cycle against qualified prospects.',
    promisedArtifact: 'Buyer evidence and a documented acquisition decision',
    responsibleOutcome: 'Send ten founder-controlled messages and earn a buyer signal or make an evidence-backed iterate, narrow, pivot, or pause decision.',
    entitlement: 'gtm_strategist',
  ...
  },
  {
    ...
    responsibleOutcome: 'Create a distribution shortlist and submit the launch where the target audience already discovers products.',
