...
export const FOUNDER_TOOL_CATALOG = [
  {
    ...
    name: 'ICP Builder',
    route: '/icp-builder',
    purpose: 'Define one best-fit customer, their urgent pain, buying trigger, and current alternative.',
  ...
  },
  {
    ...
    name: 'Demo Studio',
    route: '/demo-studio',
    purpose: 'Turn the customer decision into an interactive proof page, pitch video, and demand capture.',
  ...
  },
  {
    ...
    name: 'PMF Lab',
    route: '/pmf-lab',
    purpose: 'Combine interviews, surveys, demo behavior, and cited research into a source-weighted decision.',
  ...
  },
  {
    ...
    name: 'MVP Builder',
    route: '/mvp-builder',
    purpose: 'Turn approved customer evidence into the smallest usable product and iterate it in a live preview.',
  ...
  },
  {
    ...
    route: '/tech-stack',
    purpose: 'Choose compatible technology, integrations, rollout order, and a realistic budget for the MVP.',
  ...
  },
  {
    ...
    name: 'GTM Strategist',
    route: '/go-to-market',
    purpose: 'Choose a primary acquisition channel, create the campaign assets, and define a measurable six-week play.',
  ...
  },
  {
    ...
    name: 'Directories',
    route: '/directories',
    purpose: 'Find relevant places to submit and distribute the active launch play.',
  ...
  },
  {
    ...
    purpose: 'Track weekly acquisition experiments, activation, retention, efficiency, and evidence provenance.',
  ...
  },
  {
    ...
    stageNumber: 7,
    role: 'support',
    name: 'Insighta Test — Fundraising Readiness',
    route: '/insighta-test',
    purpose: 'Assess investor readiness across evidence, traction, narrative, team, runway, and economics.',
  ...
  },
  {
    ...
    purpose: 'Pressure-test the actual deck, narrative flow, slide coverage, and investor evidence.',
  ...
  },
  {
    ...
    name: 'VC Search',
    route: '/vc-search',
    purpose: 'Filter venture firms by stage, sector, geography, and check size and save relevant prospects.',
  ...
  },
  {
    ...
    purpose: 'Compare programs by stage, focus, geography, format, funding, and equity terms.',
  ...
  },
  {
    ...
    purpose: 'Prepare personalized investor introductions, cold outreach, follow-ups, updates, and thank-yous.',
