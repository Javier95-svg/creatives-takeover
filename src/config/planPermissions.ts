...
export const PLAN_HIGHLIGHTS: Record<Plan, string[]> = {
  ...
  rising: [
    'All five stages in one cockpit',
    'Full BizMap AI tools (GTM, Tech Stack, Pitch Deck)',
    'MVP Builder per-action billing',
    'VC Search & Accelerator Hunt (10 views/month)',
    'Unlimited Discovery Calls (10 credits/booking)',
  ],
  pro: [
    'Pro War Room + Find Your Angel',
    'Full BizMap AI tools + GTM Strategist',
    'MVP Builder per-action billing',
