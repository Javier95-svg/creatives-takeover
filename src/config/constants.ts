...
export const CREDIT_COSTS = {
  ...
  PMF_SCORING: 4,
  GTM_ANALYSIS: 5,
  APP_BUILDER_GENERATE: 1,
  APP_BUILDER_REFINE: 1,
  APP_BUILDER_DEBUG: 1,
  APP_BUILDER_ADD_PAGE: 1,
  APP_BUILDER_ADD_FEATURE: 1,
  APP_BUILDER_DESIGN_OVERHAUL: 1,
  APP_BUILDER_DEPLOY: 1,
  APP_BUILDER_RESTORE: 1,
  APP_BUILDER_EXPORT: 0,
  APP_BUILDER_CHAT: 1,
  APP_BUILDER_GITHUB_EDIT: 1,
