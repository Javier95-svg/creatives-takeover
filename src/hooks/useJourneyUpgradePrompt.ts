...
const JOURNEY_UPGRADE_CONFIG: Record<JourneyUpgradeTrigger, JourneyUpgradeConfig> = {
  ...
  starter_pmf_complete: {
    ...
    sourceTool: "PMF Lab",
    description: "You validated the market need. Rising adds more monthly credits and expands the build-and-launch workflow.",
  },
  starter_tool_mvp: {
    ...
    description: "Rising adds more monthly credits and expands the full build-and-launch layer.",
  },
  starter_tool_tech: {
    requiredCurrentPlans: ["rookie", "starter"],
    targetPlan: "rising",
    ...
    description: "Rising gives the build workflow more monthly credits and expanded launch access.",
  },
  starter_tool_gtm: {
    requiredCurrentPlans: ["rookie", "starter"],
    targetPlan: "rising",
    ...
    description: "GTM Strategist works on every plan; Rising provides more monthly credits for researched regenerations.",
  },
  starter_tool_directories: {
    requiredCurrentPlans: ["rookie", "starter"],
    targetPlan: "rising",
