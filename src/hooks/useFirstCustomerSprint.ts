...
import type { FirstCustomerDecision, FirstCustomerMessageVariant, FirstCustomerSprintSnapshot } from '@/types/firstCustomerSprint';
...
export function useFirstCustomerSprint() {
  ...
  return useMemo(() => ({
    ...
    refresh, start, update, attachContact, generateMessages, complete,
  }), [attachContact, complete, enabled, generateMessages, query.data, query.error, query.isLoading, refresh, run.isPending, start, update]);
}
