...
export const UPGRADE_TRIGGER_CONFIGS: Record<UpgradeTriggerKey, UpgradeTriggerConfig> = {
  ...
  starter_tool_mvp: {
    ...
    targetPlan: 'rising',
    headline: 'Your build stage starts with MVP Builder.',
    body: 'Rising unlocks the build-and-launch layer when validation is strong enough to scope the first usable product.',
    ctaLabel: 'Preview Rising',
  },
  starter_tool_tech: {
    key: 'starter_tool_tech',
    targetPlan: 'rising',
    headline: 'Your stack belongs after validation.',
    body: 'Rising connects MVP scope, technical choices, and launch planning in the same operating cockpit.',
    ctaLabel: 'Preview Rising',
  },
  starter_tool_gtm: {
  ...
  starter_tool_directories: {
    ...
    targetPlan: 'rising',
    headline: 'Distribution comes after the launch plan.',
    body: 'Rising surfaces directories alongside the tools that help you decide where to launch and why.',
    ctaLabel: 'Preview Rising',
  },
  rising_quota_vc: {
    key: 'rising_quota_vc',
