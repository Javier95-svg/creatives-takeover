    ...
    extend: {
      screens: {
        ...
        'no-touch': {'raw': '(hover: hover) and (pointer: fine)'},
			...
			fontSize: {
				'headline-xl': ['72px', { lineHeight: '1.04', fontWeight: '800', letterSpacing: '-0.03em' }],
				'headline-lg': ['52px', { lineHeight: '1.07', fontWeight: '800', letterSpacing: '-0.03em' }],
				'subheading-xl': ['34px', { lineHeight: '1.2', fontWeight: '700', letterSpacing: '-0.02em' }],
				'subheading-lg': ['25px', { lineHeight: '1.3', fontWeight: '600', letterSpacing: '-0.01em' }],
			...
			boxShadow: {
				...
				'glow-info': '0 0 12px rgb(59 130 246 / 0.5)',
				'glow-success': '0 0 8px rgb(16 185 129 / 0.4)',
				'glow-danger': '0 0 8px rgb(239 68 68 / 0.4)',
