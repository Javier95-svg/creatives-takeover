...
Rookie is enough to get started. Starter is the next step when you want a larger validation workload, 100 credits/month, PMF Lab, Email Templates, and deeper research access.
...
2. Upgrade to Starter for 100 credits/month and expand the validation workload: ${ctx.starterLink}
