-- Remove the foreign key constraint to allow flexible user profiles
...
-- Update each post to use a different unique user (no repeated names, excluding Javier Alonso)
