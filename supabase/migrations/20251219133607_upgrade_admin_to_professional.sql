...
BEGIN
  ...
  ON CONFLICT (user_id) DO UPDATE SET
    ...
    -- Only update balance if upgrading (current balance less than professional credits)
    balance = CASE 
      WHEN user_credits.balance < professional_credits THEN professional_credits
