-- Add demo community posts from different users
INSERT INTO community_posts (id, title, content, tags, user_id, upvotes, downvotes, comment_count, created_at, updated_at) VALUES
(
  'post-maya-chen',
